...
local extrtab = Window:CreateTab("Misc")
local setttab = Window:CreateTab("Settings")

local information = hometab:CreateSection("Information")
information:CreateLabel("Thank you for using this script, "..api.nickname)
...
information:CreateLabel("⚠️ - ⚠️ - Unsafe function")
...
local farmo = farmtab:CreateSection("Auto Farm")
...
convertatslider = farmo:CreateSlider("Convert Threshold", 0, 100, 100, false, function(Value) andromeda.vars.convertat = Value end)
local autofarmtoggle = farmo:CreateToggle("Auto Farm ⚙", nil, function(State) andromeda.toggles.autofarm = State end) autofarmtoggle:CreateKeybind("U", function(Key) end)
...
farmo:CreateToggle("Farm Coconuts & Showers", nil, function(State) andromeda.toggles.farmcoco = State end)
...
local farmt = farmtab:CreateSection("Auto Farm")
...
farmt:CreateToggle("Auto Farm萌芽", nil, function(State) andromeda.toggles.farmsprouts = State end)
farmt:CreateToggle("Auto Farm蘑菇", nil, function(State) andromeda.toggles.farmpuffshrooms = State end)
...
local farmsettings = setttab:CreateSection("自动Auto FarmSettings")
...
raresettings:CreateDropdown("Rares List", andromeda.rares, function(Option) end)
local dispsettings = setttab:CreateSection("自动分配器和自动增压器Settings")
