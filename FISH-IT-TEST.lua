...
-- Spam Completed Loop (gunakan delay slider)
...
-- Periodic Reset Loop (gunakan reset timer slider)
...
-- Slider Delay Speed (di bawah toggle)
Auto:Slider({
    Title = "Delay Speed",
    Min = 0.001,
    Max = 0.1,
...
-- Slider Reset Timer (di bawah Delay Speed)
Auto:Slider({
