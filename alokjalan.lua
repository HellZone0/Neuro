...
Modules["ui/library"] = function()
    ...
    Library.Theme = {
        ...
        -- Accent colors
        Primary = Color3.fromRGB(12, 200, 180),       -- Blurple (#5865f2)
        Success = Color3.fromRGB(12, 200, 180),       -- Green (#43b581)
        Warning = Color3.fromRGB(250, 166, 26),       -- Yellow (#faa61a)
        Danger = Color3.fromRGB(237, 66, 69),         -- Red (#ed4245)
    
        -- Text colors
        TextPrimary = Color3.fromRGB(0, 0, 0),  -- White
        TextSecondary = Color3.fromRGB(28, 28, 28), -- Gray
        TextMuted = Color3.fromRGB(114, 118, 125),    -- Muted gray
    
        -- Interactive colors
        Interactive = Color3.fromRGB(28, 28, 28),
        InteractiveHover = Color3.fromRGB(28, 28, 28),
...
Modules["main"] = function()
    ...
    print("")
    print("╔═══════════════════════════════════════════════════╗")
    print("║           🎯 Neuro Hub v1.0.0 BETA Loaded!       ║")
    print("╚═══════════════════════════════════════════════════╝")
